    ...
    var o = document.createElement("div");return o.id = h, o.className = "hidden", o.innerHTML = v, o.addEventListener("click", function (o) {
      o.preventDefault(), function () {
        var o = "function" == typeof x ? x() : x,
            ...
            r = j(),
            d = r - o;n(function o(t) {
          var e = Math.min((t - i) / y, 1);q(r - Math.round(p(e) * d)), e < 1 && n(o);
        });
      }();
      ...
      H = !0;function S() {
    j() >= M ? function () {
      if (!H) return;D.className = "", H = !1;
    }() : function () {
      if (H) return;D.className = "hidden", H = !0;
    }();
  }function j() {
