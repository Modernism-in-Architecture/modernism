    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mia_buildings.accesstype')),
            ],
        ),
        migrations.CreateModel(
            name='BuildingType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to='mia-buildings')),
                ('is_feed_image', models.BooleanField(default=False)),
                ('title', models.CharField(blank=True, max_length=250)),
                ('photographer', models.CharField(blank=True, max_length=250)),
                ('description', models.TextField(blank=True)),
                ('building', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mia_buildings.building')),
            ],
        ),
        migrations.AddField(
            model_name='building',
        ...
        migrations.AddField(
            model_name='building',
            name='city',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mia_facts.city'),
        ),
        migrations.AddField(
            model_name='building',
            name='construction_types',
            field=models.ManyToManyField(blank=True, to='mia_buildings.ConstructionType'),
        ),
        migrations.AddField(
            model_name='building',
            name='country',
